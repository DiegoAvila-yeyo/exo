...
func TestChatPostLazilyCreatesSessionAndDerivesTitleFromFirstMessage(t *testing.T) {
	...
	runner := func(_ context.Context, _ string, _ []api.Message, _ string, _ string, _ string, _ string) ([]api.Message, *NavigateAction, *CanvasSuggestion, *TurnUsage, error) {
		return []api.Message{{Role: api.RoleUser, Content: []api.Block{{Type: api.BlockText, Text: "hi"}}}}, nil, nil, nil, nil
	}
...
func TestChatSessionsIsolateHistoryBetweenSessions(t *testing.T) {
	...
	runner := func(_ context.Context, _ string, history []api.Message, _ string, _ string, _ string, _ string) ([]api.Message, *NavigateAction, *CanvasSuggestion, *TurnUsage, error) {
...
func TestChatPostThreadsProjectPathToRunnerAndPersistsIt(t *testing.T) {
	...
	runner := func(_ context.Context, _ string, _ []api.Message, projectPath string, _ string, _ string, _ string) ([]api.Message, *NavigateAction, *CanvasSuggestion, *TurnUsage, error) {
